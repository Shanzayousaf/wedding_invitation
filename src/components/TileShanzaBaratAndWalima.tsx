...
export function TileShanzaBaratAndWalima() {
  const startDateBarat = new Date('2026-01-02T18:00:00+05:00');
  const endDateBarat = new Date('2026-01-02T21:00:00+05:00');
  
  const startDateWalima = new Date('2026-01-02T20:00:00+05:00');
  const endDateWalima = new Date('2026-01-02T23:00:00+05:00');
      ...
      <div className="relative">
        ...
        <div className="p-8 md:p-10 space-y-6 border-b-2 border-[#d4af37]/40">
          ...
          <div className="space-y-2 text-center">
            <p className="text-xs uppercase tracking-[0.5em] text-[#d4af37]/70 font-serif">Barat Ceremony</p>
            <p className="text-sm font-serif text-white">Friday, January 02, 2026</p>
          </div>
        </div>

        {/* BOTTOM SECTION - TALHA & MUSKAN WALIMA */}
        <div className="p-8 md:p-10 space-y-6">
          ...
          <div className="space-y-2 text-center">
            <p className="text-xs uppercase tracking-[0.5em] text-[#d4af37]/70 font-serif">Walima Reception</p>
            <p className="text-sm font-serif text-white">Friday, January 02, 2026</p>
          </div>
        </div>

        {/* SHARED DETAILS - BOTH EVENTS */}
        <div className="px-8 md:px-10 pb-8 md:pb-10 space-y-6 border-t-2 border-[#d4af37]/40">
          {/* Date */}
          <div className="space-y-2 text-center">
            <p className="text-xs uppercase tracking-[0.5em] text-[#d4af37]/70 font-serif">Date</p>
            <p className="text-lg font-serif text-white">Friday, January 02, 2026</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="border border-[#d4af37]/30 rounded-xl bg-[#050505]/50 p-5 text-center">
              <p className="text-lg font-serif text-white">Royal Challet Lawn</p>
          ...
          <div className="space-y-3">
            ...
            <div className="border border-[#d4af37]/30 rounded-xl bg-[#050505]/50 p-5 space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-white font-serif">Gathering</span>
          ...
          <div className="space-y-3 pt-4">
            <MapButton venueName="Royal Challet Lawn, Karachi" />
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <p className="text-xs text-white/40 font-serif mb-2 text-center">Barat</p>
                  <CalendarButton
                    eventTitle="Shanza & Yasir Barat"
                    startDate={startDateBarat}
                    endDate={endDateBarat}
                    location="Royal Challet Lawn, Karachi"
                  />
                </div>
                <div>
                  <p className="text-xs text-white/40 font-serif mb-2 text-center">Walima</p>
                  <CalendarButton
                    eventTitle="Talha & Muskan Walima"
                    startDate={startDateWalima}
                    endDate={endDateWalima}
                    location="Royal Challet Lawn, Karachi"
                  />
                </div>
              </div>
