...
interface BaratPageProps {
  onNavigate: (page: 'home' | 'reception' | 'invitation' | 'barat') => void;
}

export function BaratPage({ onNavigate }: BaratPageProps) {
  const event = eventContent.barat;
